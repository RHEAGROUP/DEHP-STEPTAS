...
namespace DEHPSTEPTAS.Services.DstHubService
{
    ...
    public interface IDstHubService
    {
        ...
        bool IsSTEPTasFileType(FileRevision fileRevision);

        /// <summary>
        /// Checks if a parameter is compatible with STEP Tas mapping
        /// </summary>
        /// <param name="param">The <see cref="ParameterType"/> to check</param>
        /// <returns>True if it is a candidate for the mapping</returns>
        bool IsSTEPTasParameterType(ParameterType param);
