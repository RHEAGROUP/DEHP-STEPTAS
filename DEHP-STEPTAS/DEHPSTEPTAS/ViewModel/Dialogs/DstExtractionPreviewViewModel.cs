...
{
    /** <summary>
     * This viewmodel is used to show the result of a template processing.
     * It is just composed of a text area with scrollbars and a close button.
     * 
     * </summary>
     */
    [ExcludeFromCodeCoverage]
    class DstExtractionPreviewViewModel: IDstExtractionPreviewViewModel
    {
        
        public string PreviewResult { get; set; }

        public void SetPreviewResult(string text)   // SPA: Why do we offer the possibility to overcome property mechanism
        {
            PreviewResult = text;
        }
