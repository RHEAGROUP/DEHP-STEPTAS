// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IMappingConfigurationDialogViewModel.cs" company="Open Engineering S.A.">
...
namespace DEHPSTEPTAS.ViewModel.Dialogs.Interfaces
{
    ...
    public interface IMappingConfigurationDialogViewModel
    {
        ...
        void SetPart(StepTasRowViewModel part);

        /// <summary>
        /// Gets or sets the selected row that represents a <see cref="StepTasRowViewModel"/>
        /// </summary>
        StepTasRowViewModel SelectedThing { get; set; }
